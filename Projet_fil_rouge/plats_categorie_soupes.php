    ...
    <div class="container text-center ">
        <div class="row justify-content-center ">
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_potage_carottes.php"><img src="assets/media/img/category/Soupes et potages/potage-de-carottes.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_petit-pois.php"><img src="assets/media/img/category/Soupes et potages/potage_de_petit_pois.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_soupe_lasagne.php"><img src="assets/media/img/category/Soupes et potages/soupe-lasagne.jpg" class="card-img-top "  alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif-chaudree.php"><img src="assets/media/img/category/Soupes et potages/chaudree-fruits-de-mer.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
               <a href="descriptif_creme_brocoli.php"> <img src="assets/media/img/category/Soupes et potages/creme-de-brocoli.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_soupe_cremeuse.php"><img src="assets/media/img/category/Soupes et potages/soupe-cremeuse-haricots.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">

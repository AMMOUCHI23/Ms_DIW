    ...
    <div class="contenaire mt-5 mx-3">
        <div class="row justify-content-center">
            <div class="col-md-4 mx-3">
                <img src="../media/img/category/Plats_principaux/boulettes_farcies.jpg" class="card-img-top" alt="...">
            </div>
            <div class="col-md-5 mx-3">
                <h2 class="text-primary">Boulettes farcies </h2>
                ...
                <p>Oignon, ail, bouillon de poulet, viande de boeuf, pomme de terre,thé de cannelle girofle, sel et poivron du moulin.</p>
                <a href="" class="btn btn-primary my-2">Ajouter au panier</a><br>
                <a href="plats_catégorie_plats_principaux.php" class="btn btn-lg btn-primary my-5 ">Continuer les achats </a>

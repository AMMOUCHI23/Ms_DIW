    ...
    <div class="container text-center">
        <div class="row justify-content-center ">
           ...
           <a href="plats_categorie_entree.php"> <img id="cat1" class="img-fluid rounded " src="../media/img/category/Entrées/brochettes_de_saumon.jpg"
            ...
            <div class="col-12 col-sm-6  col-md-4 my-5 survol">
                <a href="plats_categorie_sandwich.php"><img class="img-fluid rounded " id="cat3" src="../media/img/category/Sandwichs/sandwich-vietnamien.jpg"
            ...
            <div class="col-12 col-sm-6 col-md-4 my-4 survol">
                <a href="plats_categorie_soupes.php"><img class="img-fluid rounded " id="cat3"
                    src="..//media/img/category/Soupes et potages/potage-de-carottes.jpg" width="300px" height="200px"
                    alt="image catégorie des soupes" title="image catégorie des soupes"></a>
                    <p class="categorie1 ">Nos Soupes</p>
            </div>
            <div class="col-12 col-sm-6  col-md-4 my-4  survol">
                <a href="plats_categorie_desserts.php"><img class="img-fluid rounded " id="cat3" src="..//media/img/category/Desserts/creme_glacee.jpg"
            ...
            <div class="col-12 col-sm-6  col-md-4 my-4  survol">
                <a href="plats_categorie_boissons.php"><img class="img-fluid rounded " id="cat3"
                    src="../media/img/category/Boissons et coocktails/cafe-flambé.jpg" width="300px" height="200px"

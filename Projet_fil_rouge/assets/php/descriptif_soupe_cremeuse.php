    ...
    <div class="contenaire mt-5 mx-3">
        <div class="row justify-content-center">
            <div class="col-md-4 mx-3">
                <img src="../media/img/category/Soupes_potages/soupe-cremeuse-haricots.jpg" class="card-img-top" alt="...">
            </div>
            <div class="col-md-5 mx-3">
                <h2 class="text-primary">Soupe crèmeuse aux haricots </h2>
                <h4 class="py-3">4.90 €</h4>
                <label class="card-text text-end  ">Quantité</label>
                ...
                <a href="plats_categorie_soupes.php" class="btn btn-lg btn-primary my-5 ">Continuer les achats </a>

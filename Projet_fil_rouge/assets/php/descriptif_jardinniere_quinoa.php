    ...
    <div class="contenaire mt-5 mx-3">
        <div class="row justify-content-center">
            <div class="col-md-4 mx-3">
                <img src="../media/img/category/Plats_principaux/jardinniere-quinoa.jpg" class="card-img-top" alt="...">
            </div>
            <div class="col-md-5 mx-3">
                <h2 class="text-primary">Jardinniere de quinoa </h2>
                ...
                <p>quinoa, beurre, lait, sirop d'érable, poivron, courgette, oignon, persil, ciboulette, sel et poivre du moulin.</p>

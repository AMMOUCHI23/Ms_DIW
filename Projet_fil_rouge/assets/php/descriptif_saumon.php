    ...
    <div class="contenaire mt-5 mx-3">
        <div class="row justify-content-center">
            <div class="col-md-4 mx-3">
                <img src="../media/img/category/Plats_principaux/saumon-wellington.jpg" class="card-img-top" alt="...">
            </div>
            <div class="col-md-5 mx-3">
                <h2 class="text-primary">Saumon wellington</h2>
                ...
                <p>Saumon, beurre, poireau, épinard, ail, fromage, ciboulette, muscade, pâte feuilletée, œuf, sel et poivron du moulin.</p>

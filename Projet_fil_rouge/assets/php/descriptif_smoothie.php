    ...
    <div class="contenaire mt-5 mx-3">
        <div class="row justify-content-center">
            <div class="col-md-4 mx-3">
                <img src="../media/img/category/Boissons_coocktails/smoothie-aux-fruits.jpg" class="card-img-top" alt="...">
            </div>
            <div class="col-md-5 mx-3">
                <h2 class="text-primary">Smoothie aux fruits</h2>
                <h4 class="py-3">3.50 €</h4>

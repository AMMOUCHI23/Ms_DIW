    ...
    <div class="contenaire mt-5 mx-3">
        <div class="row justify-content-center">
            <div class="col-md-4 mx-3">
                <img src="../media/img/category/Boissons_coocktails/lait_aux_fruits_rouges.jpg" class="card-img-top" alt="...">
            </div>
            <div class="col-md-5 mx-3">
                <h2 class="text-primary">Lait aux fruits rouges</h2>
                <h4 class="py-3">3.00 €</h4>

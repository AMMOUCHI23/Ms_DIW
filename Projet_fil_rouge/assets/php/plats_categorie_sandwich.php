    ...
    <div class="container text-center ">
        <div class="row justify-content-center ">
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_guedille.php"><img src="../media/img/category/Sandwichs/guédille_au_homard.png" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_hotdog.php"><img src="../media/img/category/Sandwichs/hotdog_a_la_choucroute.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_pates_crabes.php"><img src="../media/img/category/Sandwichs/pate-crabe.jpg" class="card-img-top "  alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_sandwich_poulet.php"><img src="../media/img/category/Sandwichs/sandwich-poulet.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
               <a href="descriptif_sandwich_veitnamien.php"> <img src="../media/img/category/Sandwichs/sandwich-vietnamien.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
               <a href="descriptif_sandwich_viandefum.php"> <img src="../media/img/category/Sandwichs/sandwich_en_viande_fumee.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">

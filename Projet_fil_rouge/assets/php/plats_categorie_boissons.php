    ...
    <div class="container text-center ">
        <div class="row justify-content-center ">
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_cafe_flambe.php"><img src="../media/img/category/Boissons et coocktails/cafe-flambé.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_cafe_glace.php"><img src="../media/img/category/Boissons et coocktails/cafe-glace.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_lait_frouge.php"><img src="../media/img/category/Boissons et coocktails/lait_aux_fruits_rouges .jpg" class="card-img-top " alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_lait_frappé.php"><img src="../media/img/category/Boissons et coocktails/lait_frappé_à_la_banane.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_limonade_brésilienne.php"><img src="../media/img/category/Boissons et coocktails/limonade-bresilienne.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">
            ...
            <div class="card col-justify-content  col-sm-6 col-md-4 my-4">
                <a href="descriptif_smoothie.php"><img src="../media/img/category/Boissons et coocktails/smoothie-aux-fruits.jpg" class="card-img-top" alt="..."></a>
                <div class="card-body">

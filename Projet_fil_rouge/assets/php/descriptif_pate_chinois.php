    ...
    <div class="contenaire mt-5 mx-3">
        <div class="row justify-content-center">
            <div class="col-md-4 mx-3">
                <img src="../media/img/category/Plats_principaux/pate-chinois.jpg" class="card-img-top" alt="...">
            </div>
            <div class="col-md-5 mx-3">
                <h2 class="text-primary">Pâté chinois</h2>
                ...
                <p>Patates douces, beurre salé, oignon, ail, carotte, lentilles vertes, champignons, épinards, sel et poivre du moulin.</p>

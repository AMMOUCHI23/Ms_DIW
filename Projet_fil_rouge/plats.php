        ...
        <div class="row justify-content-center ">
            <div class="col-justify-content  col-sm-6 col-md-4 my-4">
                <img id="plat1" class="img-fluid rounded "
                    src="assets/media/img/category/Plats principaux/boulettes_farcies.jpg" width="300px" height="200px"
            ...
            <div class="col-12  col-sm-6  col-md-4 my-4">
                <img class="img-fluid rounded " id="plats2"
                    src="assets/media/img/category/Plats principaux/courgettes-farcies-au-riz-sauvage.jpg" width="300px"
            ...
            <div class="col-12 col-sm-6 col-md-4 my-4">
                <img class="img-fluid rounded " id="plat4" src="assets/media/img/category/Plats principaux/pate-chinois.jpg"
            ...
            <div class="col-12 col-sm-6  col-md-4 my-4">
                <img class="img-fluid rounded " id="plat5" src="assets/media/img/category/Plats principaux/poulet_en_sauce.jpg"
            ...
            <div class="col-12 col-sm-6  col-md-4 my-4">
                <img class="img-fluid rounded " id="plat6"
                    src="assets/media/img/category/Plats principaux/saumon-wellington.jpg" width="300px" height="200px"
